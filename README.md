...
```
 wget  https://github.com/nawazish095/python-aria-mirror-bot/blob/master/generate_drive_token.py
```
...
```
wget https://github.com/nawazish095/python-aria-mirror-bot/blob/master/generate_string_session.py
```
...
python3 generate_drive_token.py
If u wish you wish to deploy it with heroku add your token.pickle to the repo and also heroku.yml app.json
```
## Deploying
